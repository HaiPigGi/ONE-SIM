...
public class SprayAndWaitRoutes extends ActiveRouter {
    ...
    public SprayAndWaitRoutes(Settings setting) {
        super(setting);
     ...
     * @param snw
     */
    protected SprayAndWaitRoutes(SprayAndWaitRoutes snw) {
        super(snw);
    ...
    @Override
    public SprayAndWaitRoutes replicate() {
        return new SprayAndWaitRoutes(this);
    }
